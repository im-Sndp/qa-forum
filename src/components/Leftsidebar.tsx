export const Leftsidebar = ({isOpen , setIsOpen}) => {
    ...
    return(
        <div>
            <aside id="separator-sidebar" className={`fixed top-16 left-0 z-40 w-64 h-screen transition-transform ${isOpen ? '' : '-translate-x-full lg:translate-x-0'}`} aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 border dark:bg-gray-800">
                <ul className="space-y-2 font-medium">
                    <li>
                        <div className="flex justify-center py-2">
                            <button className="bg-[#3699DC] text-white px-2 py-1 text-md flex items-center" onClick={()=>{
                                window.location.href = '/questions/ask'
                            }}><span className="text-3xl pb-1">+</span> ADD QUESTIONS</button>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <li>
                        <a href="/achivements" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">Badges</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">Unanswered</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            {isOpen && (
                <div className="fixed top-0 left-0 z-30 w-screen h-screen bg-black opacity-50" onClick={()=>{
                    setIsOpen(!open);
                }}>
                </div>
            )}
