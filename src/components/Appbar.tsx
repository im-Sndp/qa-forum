...
export function Appbar({isOpen , setIsOpen}) {
    ...
    <nav className="bg-[#2F3649] fixed z-50 top-0 w-full text-white border-gray-200 dark:bg-gray-900 border">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">QAengine</span>
        </a>
        ...
        <div className={`items-center justify-between ${isSearchOpen ? 'hidden' : 'w-full'} md:flex md:w-auto md:order-1`} id="navbar-search">
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <a href="/about-us" className="block py-2 px-3 text-white rounded md:bg-transparent  md:p-0 ">About</a>
            </li>
            <li>
              <a href="/policy" className="block py-2 px-3 text-white rounded md:bg-transparent  md:p-0 ">Privacy</a>
            </li>
            <li>
              <a href="/terms-condition" className="block py-2 px-3 text-white rounded md:bg-transparent  md:p-0 ">Terms</a>
            </li>
            <li>
              <a href="/contact-us" className="block py-2 px-3 text-white rounded md:bg-transparent  md:p-0 ">Contact</a>
            </li>
          </ul>
        </div>
      </div>
